...
1. Download the latest JAR from [Releases]([https://github.com/audiolomb/bamboo12.1-artifactory-plugin/releases](https://github.com/UCSD/bamboo-12.1-LTS-artifactory-plugin/releases)
