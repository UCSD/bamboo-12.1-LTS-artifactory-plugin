...
public class ArtifactoryServerConfigAction extends BambooActionSupport implements GlobalAdminSecurityAware {
    ...
    // Struts2 6.x (Bamboo 12.1) dropped the XWork convention of calling do* methods;
    // method="create" now invokes create() directly. These delegate to the existing do* methods.
    public String add() throws Exception { return doAdd(); }
    public String create() throws Exception { return doCreate(); }
    public String edit() throws Exception { return doEdit(); }
    public String update() throws Exception { return doUpdate(); }
    public String delete() throws Exception { return doDelete(); }
