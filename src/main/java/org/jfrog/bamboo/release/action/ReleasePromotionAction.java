...
public class ReleasePromotionAction extends ViewBuildResults {
    ...
    // Struts2 6.x (Bamboo 12.1) dropped the XWork do* method convention.
    // method="promote" now calls promote() directly; these delegates preserve behavior.
    public String promote() throws IOException { return doPromote(); }
    public String getLog() { return doGetLog(); }
    public String releaseBuild() throws RepositoryException, IOException { return doReleaseBuild(); }
}
