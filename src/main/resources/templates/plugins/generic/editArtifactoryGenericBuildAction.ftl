...
[@ui.bambooSection titleKey='artifactory.task.generic.deploy.title']
    ...
    [@ww.select name='builder.artifactoryGenericBuilder.artifactoryServerId' labelKey='artifactory.task.maven.artifactoryServerUrl' list=allServerConfigMaps
    ...
    <div id="genericArtifactoryConfigDiv">
        ...
        [#-- buildInfoAggregation: hidden checkbox that controls which build-info section is shown.
             cssStyle no longer hides it in Bamboo 12.1's ww.checkbox macro; use a wrapping div. --]
...
[#include '../task/ensureTaskPlanKey.ftl'/]
