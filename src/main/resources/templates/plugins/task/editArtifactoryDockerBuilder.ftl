...
[@ui.bambooSection id="resolutionSection" dependsOn='artifactory.task.docker.command.choice' showOn='pull']
    [@ww.select labelKey='artifactory.task.docker.header.resolutionArtifactoryServerId' name='artifactory.task.docker.resolutionArtifactoryServerId' list=allServerConfigMaps
...
[@ui.bambooSection id="publishSection" dependsOn='artifactory.task.docker.command.choice' showOn='push']
    [@ww.select labelKey='artifactory.task.docker.header.artifactoryServerId' name='artifactory.task.docker.artifactoryServerId' list=allServerConfigMaps
