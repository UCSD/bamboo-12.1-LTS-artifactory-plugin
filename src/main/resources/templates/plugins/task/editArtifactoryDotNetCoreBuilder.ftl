...
[@ui.bambooSection dependsOn='artifactory.task.dotnet.command.choice' showOn='restore']
    ...
    [@ui.bambooSection id="resolutionSection"]
        [@ww.select labelKey='artifactory.task.dotnet.header.resolutionArtifactoryServerId' name='artifactory.task.dotnet.resolutionArtifactoryServerId' list=allServerConfigMaps
...
[@ui.bambooSection id="publishSection" dependsOn='artifactory.task.dotnet.command.choice' showOn='push']
    [@ww.select labelKey='artifactory.task.dotnet.header.artifactoryServerId' name='artifactory.task.dotnet.artifactoryServerId' list=allServerConfigMaps
