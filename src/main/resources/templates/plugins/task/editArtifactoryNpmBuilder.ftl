...
[@ui.bambooSection id="resolutionSection" dependsOn='artifactory.task.npm.command.choice' showOn='install']
    [@ww.select labelKey='artifactory.task.npm.header.resolutionArtifactoryServerId' name='artifactory.task.npm.resolutionArtifactoryServerId' list=allServerConfigMaps
...
[@ui.bambooSection id="publishSection" dependsOn='artifactory.task.npm.command.choice' showOn='pack and publish']
    [@ww.select labelKey='artifactory.task.npm.header.artifactoryServerId' name='artifactory.task.npm.artifactoryServerId' list=allServerConfigMaps
